                    ...
                    <ul className="font-medium flex flex-col p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0 md:bg-white 
                        ...
                        <li>
                            ...
                            <button onClick={toggleDropdown} 
                                    className="py-4 px-6 text-blue-700 rounded 
                            ...
                            <div id="dropdownNavbar" 
                                ...
                                <ul className="fixed py-2 text-sm text-gray-700 dark:text-gray-400" aria-labelledby="dropdownLargeButton">
                                    ...
                                    <li>
                                        <a href="/FAQ" className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-200 dark:hover:text-white">FAQ</a>
                                    </li>
